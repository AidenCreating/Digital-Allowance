...
const el = {
  ...
  parentSignupModal: document.getElementById("parentSignupModal"),
...
function wireEvents() {
  el.openParentSignupBtn.addEventListener("click", () => {
    el.parentSignupModal.classList.remove("hidden");
    el.parentSignupModal.setAttribute("aria-hidden", "false");
  });

  el.cancelParentSignupBtn.addEventListener("click", () => {
    el.parentSignupModal.classList.add("hidden");
    el.parentSignupModal.setAttribute("aria-hidden", "true");
